...
const Products = () => {
  return (
    ...
    <main className='w-full overflow-x-hidden'>
        ...
        <ProductsDisplay title='Wrist Wraps'desc='levate your training with premium FitGrips Wrist Wraps designed for unmatched support, comfort, and durability.' button='See More' category_id='19'/>
